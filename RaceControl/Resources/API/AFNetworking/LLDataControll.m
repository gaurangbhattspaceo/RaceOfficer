...
-(NSMutableArray*)getData{
    ...
    {
       // DLog(@"exist");
        myArray=[NSArray arrayWithArray:[NSKeyedUnarchiver unarchiveObjectWithData:[NSData dataWithContentsOfFile:Path]]];
...
-(void)setData:(NSMutableArray*)dataArray{
    ...
    if (didWriteSuccessfull) {
      //  DLog(@"store succsessfully");
    }
    else {
      //  DLog(@"Eeror in Storing");
    }
