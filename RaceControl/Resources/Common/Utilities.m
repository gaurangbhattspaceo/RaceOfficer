...
#pragma mark -
#pragma mark Extenstion For UIImage
#pragma mark -
...
+ (void)showAlertWithTitle: (NSString *)title message: (NSString *)message
{
    ...
    CustomAlert *alert = [[CustomAlert alloc] initWithTitle:Alert_Title message:message delegate:self cancelButtonTitle:Button_OK otherButtonTitle:Button_Cancel];
    
    [alert showInView:DELEGATE.window];
...
+ (void)showAlert: (NSString *)message
{
    ...
    CustomAlert *alert = [[CustomAlert alloc] initWithTitle:Alert_Title message:message delegate:self cancelButtonTitle:Button_OK otherButtonTitle:nil];
