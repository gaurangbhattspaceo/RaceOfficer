...
NSString *deviceUdid()
{
    ...
    return [NSString stringWithFormat:@"%@",DELEGATE.tokenstring];
...
NSString *dayofweekFromDate(NSDate *myDate)
{

    NSDateFormatter *dateFormatter = [[NSDateFormatter alloc] init] ;
    [dateFormatter setDateFormat:@"EEEE"];
    NSString *dayofweek = [dateFormatter stringFromDate:myDate];
    return dayofweek;
}
NSString *shortnamedayofweekFromDate(NSDate *myDate)
{
    ...
    dayofweek =[dayofweek uppercaseString];
     ...
     dayofweek=[dayofweek substringToIndex:3];
...
void showIndicator()
{
   ...
   // frimbIndicator *indicator = [[frimbIndicator alloc] initWithFrame:window.bounds];
   // [indicator showIndicator:window animated:YES];
